...
module core_cpu (
    ...
    always @(*) begin
        ...
        id_clear = (jump_taken_ex | branch_taken_ex) & (~ins_invalid_ex);
    ...
    assign  LAR =  ((rd_ex == rs1_id & rs1_id != 5'b0) | (rd_ex == rs2_id & rs2_id != 5'b0 & rs2_en_id)) & (~ins_invalid_ex);
