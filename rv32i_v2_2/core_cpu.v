...
module core_cpu (
    ...
    always @(negedge rst_n or posedge clk) begin
        if (!rst_n) begin
            ...
            if (ex_clear) begin
                ...
                //         rs[rs2_id];
                a_ex <= WAR1_mem    ? bypass_mem    :
                        WAR1_mem2   ? bypass_mem2   :
                        WAR1_mem3   ? bypass_mem3   :
                        rs[rs1_id];
                b_ex <= WAR2_mem    ? bypass_mem    :
                        WAR2_mem2   ? bypass_mem2   :
                        WAR2_mem3   ? bypass_mem3   :
                        rs[rs2_id];
    ...
    always @(*) begin
        ...
        id_clear = jump_taken_ex | branch_taken_ex | jb_en;
        ex_clear = LAR | LAR2 | LAR3;
        id_stall = LAR | LAR2 | LAR3;
        stall_if = LAR | LAR2 | LAR3 | jb_en;
        ex_stall = 1'b0;
        mem_clear = 1'b0;
    end
    ...
    assign  LAR =  ((rd_ex == rs1_id & rs1_id != 5'b0) | (rd_ex == rs2_id & rs2_id != 5'b0 & rs2_en_id));
