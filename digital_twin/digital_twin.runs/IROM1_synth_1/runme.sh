...
HD_PWD='E:/Vivado_code/digital_twin/digital_twin.runs/IROM1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IROM1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IROM1.tcl
