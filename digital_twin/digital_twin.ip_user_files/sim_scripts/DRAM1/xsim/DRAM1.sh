...
#
# Script generated by Vivado on Mon Apr 06 00:48:19 +0800 2026
...
# script info
echo -e "DRAM1.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DRAM1 xil_defaultlib.DRAM1 xil_defaultlib.glbl -log elaborate.log
}
...
Usage: DRAM1.sh [-rerun]\n\
Usage: DRAM1.sh [-reset_run]\n\
Usage: DRAM1.sh [-clean]\n\
