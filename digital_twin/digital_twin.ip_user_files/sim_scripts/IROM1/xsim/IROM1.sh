...
#
# Script generated by Vivado on Mon Apr 06 00:38:19 +0800 2026
...
#
# Usage        : IROM1.sh
#                IROM1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                IROM1.sh [-rerun]
#                IROM1.sh [-reset_run]
#                IROM1.sh [-clean]
#                IROM1.sh [-reset_log]
...
# script info
echo -e "IROM1.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./IROM1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot IROM1 xil_defaultlib.IROM1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim IROM1 -key {Behavioral:sim_1:Functional:IROM1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb IROM1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./IROM1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: IROM1.sh [-help]\n\
Usage: IROM1.sh [-step]\n\
Usage: IROM1.sh [-lib_map_path]\n\
Usage: IROM1.sh [-rerun]\n\
Usage: IROM1.sh [-reset_run]\n\
Usage: IROM1.sh [-clean]\n\
Usage: IROM1.sh [-reset_log]\n\
Usage: IROM1.sh [-keep_index]\n\
Usage: IROM1.sh [-noclean_files]\n\n\
