...
module perip_bridge (
    ...
    // localparam DRAM_ADDR_START = 32'h0;
    ...
    cache_driver cache_driver_inst (
        .clk                (clk),
        .rst                (rst),
        .addr               (perip_addr_reg),
        .dram_rdata         (dram_rdata_word),
        .wdata              (perip_wdata_reg),
        .ren                ((~(&perip_mask_reg)) & (perip_addr_reg >= DRAM_ADDR_START && perip_addr_reg < DRAM_ADDR_END)),
        .wen                (perip_wen_reg & (perip_addr_reg >= DRAM_ADDR_START && perip_addr_reg < DRAM_ADDR_END)),
        .mask               (perip_mask_reg),
        .hit                (hit),
