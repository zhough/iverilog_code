module  BCB(
    ...
    input           update_en_ex,
    input           clear_en_ex,
    input           update_branch_en_ex,
    input           update_branch_not_en_ex,
    output          bcb_pred_correct,
    output  [31:0]  bcb_update_pc,
    output  [31:0]  bcb_update_target,
    output          bcb_update_en,
    output          bcb_clear_en,
    output          bcb_update_branch_en,
    output          bcb_update_branch_not_en,
    ...
    assign  bcb_update_branch_en = update_branch_en_ex;
    assign  bcb_update_branch_not_en = update_branch_not_en_ex;
