...
module perip_bridge (
    ...
    assign perip_rdata = (perip_addr_reg == CNT_ADDR) ? cnt_rdata :
                        (perip_addr_reg >= DRAM_ADDR_START && perip_addr_reg < DRAM_ADDR_END) ? dram_rdata :
                        (perip_addr_reg == SEG_ADDR) ? sim_seg :
                        32'b0;
