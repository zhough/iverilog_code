...
VL_ATTR_COLD void Vtop___024root___eval_initial__TOP(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_READMEM_N(true, 32, 8193, 0, "./hex/src0/irom.hex"s
                 ,  &(vlSelfRef.top__DOT__u_irom__DOT__mem)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 65536, 0, "./hex/test_src/dram.hex"s
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->cnt = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 11575427343217569569ull);
    ...
    vlSelf->top__DOT__Core_CPU__DOT__id_clear = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17182706772050047567ull);
    ...
    vlSelf->top__DOT__u_perip__DOT__sim_seg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 2379552961338945684ull);
    vlSelf->top__DOT__u_perip__DOT____VdfgRegularize_hff7cac4e_0_0 = 0;
