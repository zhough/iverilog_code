...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , perip_mask{vlSymsp->TOP.perip_mask}
    , perip_wen{vlSymsp->TOP.perip_wen}
    , perip_addr{vlSymsp->TOP.perip_addr}
    , perip_wdata{vlSymsp->TOP.perip_wdata}
    , perip_rdata{vlSymsp->TOP.perip_rdata}
    , rootp{&(vlSymsp->TOP)}
{
