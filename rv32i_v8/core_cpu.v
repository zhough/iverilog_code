...
module core_cpu (
    ...
    assign WAR1_mem2 = (rd_mem2 == rs1_id) & rd_en_mem2 & (~is_load_mem2) & (rs1_id != 5'b0);
    assign WAR2_mem2 = (rd_mem2 == rs2_id) & rd_en_mem2 & (~is_load_mem2) & (rs2_id != 5'b0);
    ...
    always @(negedge rst_n or posedge clk) begin
        if (!rst_n) begin
            ...
            rd_mem3 <= 5'b0;
            rd_en_mem3 <= 1'b0;
            wb_result_mem2 <=32'b0;
            wb_result_mem2_reg <= 32'b0;
            is_load_mem2 <= 1'b0;
            is_load_mem3 <= 1'b0;
        end else begin
            is_load_mem2 <= is_load_mem;
            wb_result_mem2 <= wb_result_mem;
            rd_mem2 <= rd_mem;
