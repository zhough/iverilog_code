...
wire [2:0] funct3_1 = ins1[14:12];
wire [6:0] funct7_1 = ins1[31:25];
wire [11:0] immi_1 = ins1[31:20];     // I型指令立即数
wire [11:0] imms_1 = {ins1[31:25],ins1[11:7]};      //S型指令立即数
wire [12:0] immb_1 = {ins1[31],ins1[7],ins1[30:25],ins1[11:8],1'b0};  //B型指令立即数
wire [19:0] immu_1 = ins[31:12];      //U型指令立即数
wire [20:0] immj_1 = {ins1[31],ins1[19:12],ins1[20],ins1[30:21],1'b0};    //J型指令立即数
assign rd_1 = ins1[11:7];     //目标寄存器地址
assign rs1_1 = ins1[19:15];   //地址
assign rs2_1 = ins1[24:20];   //地址


reg alu_src_reg,jump_en_reg,branch_en_reg,is_jalr_reg,is_lui_reg,is_auipc_reg,rd_en_reg;
reg [3:0] alu_op_reg;
reg [31:0] imm_reg;
reg [2:0] load_op_reg;
reg [2:0] store_op_reg;
reg rs2_en_reg, rs1_en_reg;
...
assign rs2_en = rs2_en_reg; //rs2有效标志位
assign rs1_en = rs1_en_reg;
